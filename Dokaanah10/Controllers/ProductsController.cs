...
namespace Dokaanah10.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController( ) //DokkanahContex10 context)
        {
            //_context = context;
        }
        ...
        {
            var dokkanahContex10 = _context.Products.Include(p => p.Order).Include(p => p.Seller);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,ImgUrl,Sellerid,Orderid")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,ImgUrl,Sellerid,Orderid")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
